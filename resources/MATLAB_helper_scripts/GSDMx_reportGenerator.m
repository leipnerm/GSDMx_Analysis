function reportGenerator_20201116(file,directory,T,surfCov)
...
tp.PubDate = char(dt);
tp.Image = [file.folder,'/',file.name(1:end-4),'.jpg'];
add(R,tp);
...
im1 = FormalImage();
im1.Image = strjoin([directory,'/images/',file.name(8:end-6),'_1_raw.png'],'');
...
im2 = FormalImage();
im2.Image = strjoin([directory,'/images/',file.name(8:end-6),'_2_flat.png'],'');
...
im3 = FormalImage();
im3.Image = strjoin([directory,'/images/',file.name(8:end-6),'_3_all.png'],'');
...
im3 = FormalImage();
im3.Image = strjoin([directory,'/images/',file.name(8:end-6),'_4_isolated.png'],'');
...
im4 = FormalImage();
im4.Image = strjoin([directory,'/images/',file.name(8:end-6),'_5_watershedded.png'],'');
add(chapter4,im4);
add(R,chapter4);
...
im5 = FormalImage();
im5.Image = strjoin([directory,'/images/',file.name(8:end-6),'_7_labeled.png'],'');
add(chapter5,im5);
add(R,chapter5);
...
im6 = FormalImage();
im6.Image = strjoin([directory,'/images/',file.name,'_6_axis.png'],'');
add(chapter6,im6);
add(R,chapter6);
...
srcDir = strjoin([directory,'/images/'],'');
